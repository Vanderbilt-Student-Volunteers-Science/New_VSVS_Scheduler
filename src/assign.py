...
class Assign:
    ...
    def sort_by_availability(list):
        ...
        half_1 = src.assign.sort_by_availability(list[0:pivot_idx])
        half_2 = src.assign.sort_by_availability(list[pivot_idx:(list.len())])
        return src.assign.merge(half_1, half_2)
